...
set seed 896124
clear
set obs 25 //number of schools 
generate school = _n
generate u_i = rnormal(0,1)  // SCHOOL EFFECTS
expand 20 //20 students in each school

bysort school: generate student_id = _n //create classroom id

gen math_score = rnormal(0,1) + u_i

vioplot math_score , over(school)

loneway math_score school
